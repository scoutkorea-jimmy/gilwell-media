...
| --- | --- | --- | --- |
| `VERSION` | `00.111.11` | 중간 | Site 버전 소스 오브 트루스로 유지 |
...
| 공개 HTML (`index.html`, `latest.html`, `korea.html`, `apr.html`, `wosm.html`, `wosm-members.html`, `people.html`, `glossary.html`, `contributors.html`, `search.html`, `calendar.html`) | `?v=00.111.11` | 높음 | sync 스크립트로 자동 주입 |
| SSR 파일 (`functions/post/[id].js`, `functions/feature/[category]/[slug].js`, `functions/glossary-raw.js`) | `?v=00.111.11` | 높음 | sync 스크립트로 자동 주입 |
