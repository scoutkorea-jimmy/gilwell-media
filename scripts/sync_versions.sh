...
printf '%s\n' "$ASSET_VERSION" > public/ASSET_VERSION
...
PAGE_CSS_FILES=(
  public/latest.html public/korea.html public/apr.html public/wosm.html public/people.html
  public/calendar.html public/wosm-members.html public/glossary.html public/jamboree16.html
...
# public/memorabilia.html — its own public/js/css + shared module (memorabilia-shared.js)
perl -0pi -e "s#/css/memorabilia\\.css\\?v=[0-9A-Za-z.-]+#/css/memorabilia.css?v=${ASSET_VERSION}#g; s#/js/memorabilia\\.js\\?v=[0-9A-Za-z.-]+#/js/memorabilia.js?v=${ASSET_VERSION}#g; s#/js/memorabilia-shared\\.js\\?v=[0-9A-Za-z.-]+#/js/memorabilia-shared.js?v=${ASSET_VERSION}#g" public/memorabilia.html

# public/admin.html — admin-memorabilia.js + memorabilia 공유 자산 (public/admin.html 도 같은 public/css/shared module 사용)
perl -0pi -e "s#/js/admin-memorabilia\\.js\\?v=[0-9A-Za-z.-]+#/js/admin-memorabilia.js?v=${ASSET_VERSION}#g; s#/js/admin-memorabilia-comments\\.js\\?v=[0-9A-Za-z.-]+#/js/admin-memorabilia-comments.js?v=${ASSET_VERSION}#g; s#/js/memorabilia-shared\\.js\\?v=[0-9A-Za-z.-]+#/js/memorabilia-shared.js?v=${ASSET_VERSION}#g; s#/css/memorabilia\\.css\\?v=[0-9A-Za-z.-]+#/css/memorabilia.css?v=${ASSET_VERSION}#g" public/admin.html

perl -0pi -e "s/\\/dreampath\\/app\\.js\\?v=[0-9A-Za-z.-]+/\\/dreampath\\/app.js?v=${ASSET_VERSION}/g" public/dreampath/index.html
perl -0pi -e "s#templates\\.css\\?v=[0-9A-Za-z.-]+#templates.css?v=${ASSET_VERSION}#g; s#dp-assets\\.js\\?v=[0-9A-Za-z.-]+#dp-assets.js?v=${ASSET_VERSION}#g; s#templates-export\\.js\\?v=[0-9A-Za-z.-]+#templates-export.js?v=${ASSET_VERSION}#g; s#templates-app\\.js\\?v=[0-9A-Za-z.-]+#templates-app.js?v=${ASSET_VERSION}#g" "public/dreampath/templates/DreamPath - Document Templates.html"

perl -0pi -e "s/GW\\.APP_VERSION = '[0-9.]+'/GW.APP_VERSION = '${SITE_VERSION}'/g; s/GW\\.ADMIN_VERSION = '[0-9.]+'/GW.ADMIN_VERSION = '${ADMIN_VERSION}'/g; s/GW\\.ASSET_VERSION = '[^']+'/GW.ASSET_VERSION = '${ASSET_VERSION}'/g" public/js/main.js
perl -0pi -e "s/Version: [0-9.]+/Version: ${ADMIN_VERSION}/g" public/js/admin-v3.js
...
perl -0pi -e "s#/css/admin-v3\\.css\\?v=[0-9A-Za-z.-]+#/css/admin-v3.css?v=${ASSET_VERSION}#g; s#(<span class=\"v3-ver-str v3-ver-admin admin-build-version\">)[^<]*(</span>)#\${1}V${ADMIN_VERSION}\${2}#g; s#(<span class=\"v3-logo-version v3-ver-str v3-ver-admin admin-build-version\">)[^<]*(</span>)#\${1}V${ADMIN_VERSION}\${2}#g; s#(<span class=\"v3-ver-str v3-ver-site site-build-version\">)[^<]*(</span>)#\${1}V${SITE_VERSION}\${2}#g; s#(<span class=\"v3-ver-site site-build-version\">)[^<]*(</span>)#\${1}V${SITE_VERSION}\${2}#g; s#/js/main\\.js\\?v=[0-9A-Za-z.-]+#/js/main.js?v=${ASSET_VERSION}#g; s#/js/shared-country-name-ko\\.js\\?v=[0-9A-Za-z.-]+#/js/shared-country-name-ko.js?v=${ASSET_VERSION}#g; s#/js/admin-v3\\.js\\?v=[0-9A-Za-z.-]+#/js/admin-v3.js?v=${ASSET_VERSION}#g; s#/js/admin-account\\.js\\?v=[0-9A-Za-z.-]+#/js/admin-account.js?v=${ASSET_VERSION}#g; s#/js/admin-cardnews\\.js\\?v=[0-9A-Za-z.-]+#/js/admin-cardnews.js?v=${ASSET_VERSION}#g" public/admin.html
perl -0pi -e "s#/css/style\\.css\\?v=[0-9A-Za-z.-]+#/css/style.css?v=${ASSET_VERSION}#g; s#/css/admin\\.css\\?v=[0-9A-Za-z.-]+#/css/admin.css?v=${ASSET_VERSION}#g; s#/css/chatbot\\.css\\?v=[0-9A-Za-z.-]+#/css/chatbot.css?v=${ASSET_VERSION}#g; s#/js/main\\.js\\?v=[0-9A-Za-z.-]+#/js/main.js?v=${ASSET_VERSION}#g; s#/js/kms\\.js\\?v=[0-9A-Za-z.-]+#/js/kms.js?v=${ASSET_VERSION}#g; s#/js/chatbot\\.js\\?v=[0-9A-Za-z.-]+#/js/chatbot.js?v=${ASSET_VERSION}#g; s/Admin v[0-9.]+/Admin v${ADMIN_VERSION}/g" public/kms.html

# Chatbot widget — pages outside SITE_FILES (404, editorial-policy, privacy)
CHATBOT_EXTRA=(public/404.html public/editorial-policy.html public/privacy.html)
