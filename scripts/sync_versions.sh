...
perl -0pi -e "s#/css/admin-v3\\.css\\?v=[0-9A-Za-z.-]+#/css/admin-v3.css?v=${ASSET_VERSION}#g; s#(<span class=\"v3-ver-str v3-ver-admin admin-build-version\">)[^<]*(</span>)#\${1}V${ADMIN_VERSION}\${2}#g; s#(<span class=\"v3-logo-version v3-ver-str v3-ver-admin admin-build-version\">)[^<]*(</span>)#\${1}V${ADMIN_VERSION}\${2}#g; s#(<span class=\"v3-ver-str v3-ver-site site-build-version\">)[^<]*(</span>)#\${1}V${SITE_VERSION}\${2}#g; s#(<span class=\"v3-ver-site site-build-version\">)[^<]*(</span>)#\${1}V${SITE_VERSION}\${2}#g; s#/js/main\\.js\\?v=[0-9A-Za-z.-]+#/js/main.js?v=${ASSET_VERSION}#g; s#/js/shared-country-name-ko\\.js\\?v=[0-9A-Za-z.-]+#/js/shared-country-name-ko.js?v=${ASSET_VERSION}#g; s#/js/admin-v3\\.js\\?v=[0-9A-Za-z.-]+#/js/admin-v3.js?v=${ASSET_VERSION}#g; s#/js/admin-account\\.js\\?v=[0-9A-Za-z.-]+#/js/admin-account.js?v=${ASSET_VERSION}#g" admin.html
