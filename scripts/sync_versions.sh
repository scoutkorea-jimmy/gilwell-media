...
perl -0pi -e "s/\\/dreampath\\/app\\.js\\?v=[0-9A-Za-z.-]+/\\/dreampath\\/app.js?v=${ASSET_VERSION}/g" dreampath/index.html
perl -0pi -e "s#templates\\.css\\?v=[0-9A-Za-z.-]+#templates.css?v=${ASSET_VERSION}#g; s#dp-assets\\.js\\?v=[0-9A-Za-z.-]+#dp-assets.js?v=${ASSET_VERSION}#g; s#templates-export\\.js\\?v=[0-9A-Za-z.-]+#templates-export.js?v=${ASSET_VERSION}#g; s#templates-app\\.js\\?v=[0-9A-Za-z.-]+#templates-app.js?v=${ASSET_VERSION}#g" "dreampath/templates/DreamPath - Document Templates.html"
