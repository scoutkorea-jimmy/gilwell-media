...
| `dist-homepage/templates-app.js` `syncAutoPages` / `restoreFlowToFirst` / `cloneForOverflow` | 2026-06-09 | 매 입력마다 문단 노드 재배치 → 캐럿 파괴. fast-path(무오버플로 시 미이동) + 캐럿 캡처/복원 + tail 머지 |
