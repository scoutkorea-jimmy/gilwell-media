...
- 파일: `functions/api/dreampath/wiki.js`, `wiki-comments.js`, `js/dreampath.js`(위키 모듈), `dreampath.html`(로더+CSS), `js/vendor/pdf.worker.min.js`. 테이블 `dp_wiki_pages/_versions/_followups/_comments` (`migrations/dp_wiki_2026-06-04.sql`).
