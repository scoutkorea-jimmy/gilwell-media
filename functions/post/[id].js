...
<head>
  ...
  <link rel="stylesheet" href="/css/style.css?v=0.021.00">
</head>
<body>
  ...
  <footer>
    <div class="footer-inner">
      ...
      <div>
        ...
        <p class="footer-build">Build <span class="site-build-version">V0.021.00</span></p>
      </div>
  ...
  <script src="/js/main.js?v=0.021.00"></script>
  <script>
    GW.setMastheadDate();
    GW.markActiveNav();
