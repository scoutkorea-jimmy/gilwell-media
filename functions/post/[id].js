...
<head>
  ...
  <link rel="stylesheet" href="/css/style.css?v=0.048.28">
</head>
<body>
  ...
  <header class="masthead">
    ...
    <nav class="nav">
      ...
      <a href="/glossary.html" data-i18n="nav.glossary">용어집</a>
    </nav>
  </header>
  ...
  <footer>
    <div class="footer-inner">
      ...
      <div class="footer-admin">
        ...
        <p class="footer-build">Build <span class="site-build-version">V0.048.28</span></p>
      </div>
  ...
  <script src="/js/main.js?v=0.048.28"></script>
  <script>
    GW.setMastheadDate();
    GW.markActiveNav();
