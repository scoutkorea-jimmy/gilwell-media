...
function isPublicPagePath(path) {
  ...
  if (clean === '/korea.html' || clean === '/apr.html' || clean === '/wosm.html' || clean === '/worm.html' || clean === '/people.html' || clean === '/glossary.html' || clean === '/contributors.html' || clean === '/search.html' || clean === '/404.html') return true;
