...
## 6 작업 효율성 노트 (Site / Admin) — 별도 파일

> [!info] 매 턴 자동 로드되지 않음 — 필요 시 직접 읽기
> 실작업 인사이트 12개(Enum 카탈로그 동기화, PUT 권한 게이트, 모달 패턴, P0 transient 판별 등)는 토큰 절감을 위해 **[docs/working-notes.md](docs/working-notes.md)** 로 분리됨.
>
> **언제 읽어야 하나:**
> - 신규 admin 패널 / 모달 / 카탈로그 추가
> - Site/Admin 회귀 버그 디버깅
> - homepage_issues에 새 severity·code 추가
...
### Site / Admin
- [[docs/working-notes|작업 효율성 노트]] — 실작업 인사이트 12개 (회귀 디버깅·신규 기능 착수 시 직접 읽기)
