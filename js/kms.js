    ...
    var sections = [
      ...
      // ────────────────────────────────────────────────────────
      {
        ...
        html: [
          ...
          // Primary Filled
          '<tr>',
          '<td class="kms-ds-t-name">저장·제출 버튼<br><small style="font-weight:300;letter-spacing:0">Primary 44px · bg #1f1f1f</small></td>',
          '<td class="kms-ds-t-usage">관리자 게시글 저장, 캘린더 행사 확정, 폼 제출 등 주요 확정 액션<br><code style="font-size:10px;font-family:monospace">.submit-btn .write-btn .calendar-manage-btn</code></td>',
          ...
          // Primary Accent
          '<tr>',
          '<td class="kms-ds-t-name">작성·등록 버튼<br><small style="font-weight:300;letter-spacing:0">Primary 44px · bg #622599</small></td>',
          '<td class="kms-ds-t-usage">새 게시글 작성, 캘린더 행사 등록 — 관리자 페이지 상단 고정 버튼<br><code style="font-size:10px;font-family:monospace">.write-btn</code></td>',
          ...
          // Primary Outline
          '<tr>',
          '<td class="kms-ds-t-name">취소 버튼<br><small style="font-weight:300;letter-spacing:0">Primary 44px · 아웃라인</small></td>',
          '<td class="kms-ds-t-usage">작성 취소, 모달 닫기 — 저장 버튼 옆에 나란히 배치<br><code style="font-size:10px;font-family:monospace">.cancel-btn.visible</code></td>',
          ...
          // Primary Danger
          '<tr>',
          '<td class="kms-ds-t-name">삭제 버튼<br><small style="font-weight:300;letter-spacing:0">Primary 44px · 빨간 아웃라인</small></td>',
          '<td class="kms-ds-t-usage">게시글 삭제, 행사 삭제 — 되돌릴 수 없는 위험 액션<br><code style="font-size:10px;font-family:monospace">.btn-delete-soft.visible</code></td>',
          ...
          // Primary Disabled
          '<tr>',
          '<td class="kms-ds-t-name">비활성 버튼<br><small style="font-weight:300;letter-spacing:0">Primary 44px · opacity 0.4</small></td>',
          '<td class="kms-ds-t-usage">요청 처리 중, 유효성 미충족 — 모든 Primary 계열에 적용<br><code style="font-size:10px;font-family:monospace">disabled</code></td>',
          ...
          // Secondary Default
          '<tr>',
          '<td class="kms-ds-t-name">뷰전환·페이지 버튼<br><small style="font-weight:300;letter-spacing:0">Secondary 36px · 아웃라인</small></td>',
          '<td class="kms-ds-t-usage">캘린더 달력·목록·지도 뷰 전환, 게시판 페이지네이션 번호<br><code style="font-size:10px;font-family:monospace">.calendar-view-btn .board-page-btn .calendar-today-btn</code></td>',
          ...
          '<tr>',
          '<td class="kms-ds-t-name">선택된 뷰·현재 페이지<br><small style="font-weight:300;letter-spacing:0">Secondary 36px · bg #1f1f1f</small></td>',
          '<td class="kms-ds-t-usage">현재 선택된 뷰 강조, 현재 페이지 번호 강조<br><code style="font-size:10px;font-family:monospace">.board-page-btn.active .calendar-view-btn.active</code></td>',
          ...
          '<tr>',
          '<td class="kms-ds-t-name">퍼플 강조 뷰<br><small style="font-weight:300;letter-spacing:0">Secondary 36px · 퍼플 bg 연하</small></td>',
          '<td class="kms-ds-t-usage">캘린더 지도 보기 등 특수 강조 뷰 — 퍼플 계열 식별<br><code style="font-size:10px;font-family:monospace">.calendar-view-btn.active</code></td>',
      ...
      // ────────────────────────────────────────────────────────
      {
        ...
        html: [
          ...
          // 지역 카테고리 키커
          '<tr>',
          '<td class="kms-ds-t-name">지역 카테고리 키커<br><small style="font-weight:300;letter-spacing:0">26px · 아웃라인 컬러</small></td>',
          '<td class="kms-ds-t-usage">게시글 카드 상단 레이블, 기사 상세 페이지 — 지역별 색상 구분<br><code style="font-size:10px;font-family:monospace">.post-kicker .tag-{region}-kicker</code></td>',
          ...
          // 행사 상태 배지
          '<tr>',
          '<td class="kms-ds-t-name">행사 진행 상태 배지<br><small style="font-weight:300;letter-spacing:0">26px · 아웃라인 컬러</small></td>',
          '<td class="kms-ds-t-usage">캘린더 행사 카드 — 예정(퍼플)/진행중(초록)/종료(회색) 상태 구분<br><code style="font-size:10px;font-family:monospace">.calendar-status-badge.is-upcoming / .is-ongoing / .is-finished</code></td>',
          ...
          // 대상 칩
          '<tr>',
          '<td class="kms-ds-t-name">행사 대상 칩<br><small style="font-weight:300;letter-spacing:0">26px · 검정 아웃라인</small></td>',
          '<td class="kms-ds-t-usage">캘린더 행사 카드 — 참가 대상 스카우트 구분 (비버·컵스·스카우트·지도자·로버)<br><code style="font-size:10px;font-family:monospace">.calendar-target-chip</code></td>',
          ...
          // 지역 배지
          '<tr>',
          '<td class="kms-ds-t-name">행사 지역 배지<br><small style="font-weight:300;letter-spacing:0">26px · 지역 컬러 텍스트</small></td>',
          '<td class="kms-ds-t-usage">캘린더 행사 카드 — 주관 지역 구분 (KOR·APR·WOSM·EUR·AFR 등)<br><code style="font-size:10px;font-family:monospace">.calendar-category-badge.is-kor / .is-apr / .is-wosm</code></td>',
          ...
          // 필터 칩
          '<tr>',
          '<td class="kms-ds-t-name">콘텐츠 필터 칩<br><small style="font-weight:300;letter-spacing:0">26px · 토글 방식</small></td>',
          '<td class="kms-ds-t-usage">게시판 카테고리 필터, 캘린더 행사 유형 필터 탭 — 선택 시 검정 채움<br><code style="font-size:10px;font-family:monospace">.filter-btn / .filter-btn.active</code></td>',
          ...
          // 태그 칩
          '<tr>',
          '<td class="kms-ds-t-name">태그 칩<br><small style="font-weight:300;letter-spacing:0">26px · 토글 방식</small></td>',
          '<td class="kms-ds-t-usage">게시글 태그, 검색 결과 태그 필터 — 선택 시 검정 채움<br><code style="font-size:10px;font-family:monospace">.tag-pill / .tag-pill.active</code></td>',
      ...
      // ────────────────────────────────────────────────────────
      {
        ...
        html: [
          ...
          // Text Input
          '<tr>',
          '<td class="kms-ds-t-name">단행 텍스트 입력<br><small style="font-weight:300;letter-spacing:0">40px · border-radius:0</small></td>',
          '<td class="kms-ds-t-usage">제목, URL, 검색어 등 한 줄 입력 — 관리자 게시글 폼, 캘린더 행사 폼<br><code style="font-size:10px;font-family:monospace">.form-group input[type=text]</code></td>',
          ...
          // Select
          '<tr>',
          '<td class="kms-ds-t-name">선택 드롭다운<br><small style="font-weight:300;letter-spacing:0">40px · border-radius:0</small></td>',
          '<td class="kms-ds-t-usage">카테고리 분류, 상태 선택, 정렬 기준 — 관리자 게시글·캘린더 폼<br><code style="font-size:10px;font-family:monospace">.form-group select</code></td>',
          ...
          // Date Input
          '<tr>',
          '<td class="kms-ds-t-name">날짜 입력<br><small style="font-weight:300;letter-spacing:0">40px · border-radius:0</small></td>',
          '<td class="kms-ds-t-usage">날짜 지정 — 캘린더 행사 시작·종료일, 관리자 기간 필터<br><code style="font-size:10px;font-family:monospace">.form-group input[type=date]</code></td>',
          ...
          // Textarea
          '<tr>',
          '<td class="kms-ds-t-name">여러 줄 텍스트 입력<br><small style="font-weight:300;letter-spacing:0">height:auto · border-radius:0</small></td>',
          '<td class="kms-ds-t-usage">본문 요약, 기사 내용, 메모 — 관리자 게시글 편집기, 행사 설명<br><code style="font-size:10px;font-family:monospace">.form-group textarea</code></td>',
          ...
          // Disabled
          '<tr>',
          '<td class="kms-ds-t-name">비활성 입력<br><small style="font-weight:300;letter-spacing:0">40px · opacity 0.4</small></td>',
          '<td class="kms-ds-t-usage">조건 미충족, 잠긴 필드 — 읽기 전용 설정값, 서버에서 채워지는 필드<br><code style="font-size:10px;font-family:monospace">input[disabled] select[disabled]</code></td>',
      ...
      // ────────────────────────────────────────────────────────
      {
        ...
        html: [
          ...
          // 기본
          '<tr>',
          '<td class="kms-ds-t-name">편집 아이콘 버튼<br><small style="font-weight:300;letter-spacing:0">28×28px · 투명 배경</small></td>',
          '<td class="kms-ds-t-usage">게시글 목록 편집, 캘린더 행사 수정 — 테이블 행 우측 배치, hover 시 배경 변화<br><code style="font-size:10px;font-family:monospace">.btn-icon .btn-edit</code></td>',
          ...
          // Danger
          '<tr>',
          '<td class="kms-ds-t-name">삭제 아이콘 버튼<br><small style="font-weight:300;letter-spacing:0">28×28px · 빨간 아이콘</small></td>',
          '<td class="kms-ds-t-usage">게시글 삭제, 행사 삭제 — 테이블 행 우측 위험 액션, hover 시 danger 배경<br><code style="font-size:10px;font-family:monospace">.btn-icon.btn-icon-danger .btn-delete</code></td>',
          ...
          // Success
          '<tr>',
          '<td class="kms-ds-t-name">확인 아이콘 버튼<br><small style="font-weight:300;letter-spacing:0">28×28px · 초록 아이콘</small></td>',
          '<td class="kms-ds-t-usage">용어 승인, 인라인 확인 — 테이블 행 우측 성공 액션, hover 시 success 배경<br><code style="font-size:10px;font-family:monospace">.btn-icon.btn-icon-success</code></td>',
      ...
      // ────────────────────────────────────────────────────────
      {
        ...
        html: [
          ...
          // 카드 그리드 뷰
          '<tr>',
          '<td class="kms-ds-t-name">카드 그리드 뷰<br><small style="font-weight:300;letter-spacing:0">PC·태블릿 · minmax(220px,1fr)</small></td>',
          '<td class="kms-ds-t-usage">캘린더 페이지 기본 뷰 — grid-template-columns: repeat(auto-fill, minmax(220px,1fr)) / gap:8px / 지역별 상단 컬러 선 3px<br><code style="font-size:10px;font-family:monospace">.calendar-event-card.is-category-{region}</code></td>',
          ...
          // 모바일 단열 뷰
          '<tr>',
          '<td class="kms-ds-t-name">모바일 단열 뷰<br><small style="font-weight:300;letter-spacing:0">480px 이하 · 1열 전체 너비</small></td>',
          '<td class="kms-ds-t-usage">모바일에서 grid-template-columns: 1fr 으로 변경 — 카드가 전체 너비로 1열 표시<br><code style="font-size:10px;font-family:monospace">@media (max-width:480px)</code></td>',
          ...
          // 종료 행사
          '<tr>',
          '<td class="kms-ds-t-name">종료된 행사 카드<br><small style="font-weight:300;letter-spacing:0">.is-finished 상태</small></td>',
          '<td class="kms-ds-t-usage">종료된 행사 — 배경 #f6f6f6, 테두리 #d8d8d8으로 흐리게 처리<br><code style="font-size:10px;font-family:monospace">.calendar-event-card.is-finished</code></td>',
      ...
      // ────────────────────────────────────────────────────────
      {
        ...
        html: [
          ...
          // 마스트헤드 인라인 검색
          '<tr>',
          '<td class="kms-ds-t-name">마스트헤드 인라인 검색<br><small style="font-weight:300;letter-spacing:0">헤더 우측 상단</small></td>',
          '<td class="kms-ds-t-usage">헤더 우측 검색 아이콘 클릭 시 노출 — 하단 border만 있는 미니멀 입력창<br><code style="font-size:10px;font-family:monospace">.masthead-search .mh-search-input .mh-search-btn</code></td>',
          ...
          // 전역 검색 패널
          '<tr>',
          '<td class="kms-ds-t-name">전역 검색 패널<br><small style="font-weight:300;letter-spacing:0">헤더 아래 펼쳐지는 바</small></td>',
          '<td class="kms-ds-t-usage">마스트헤드 검색 아이콘 클릭 시 헤더 바로 아래 전체 너비로 표시 — 검색어 입력 후 결과를 카드 그리드로 표시<br><code style="font-size:10px;font-family:monospace">.global-search-bar .global-search-input .global-search-btn .global-search-close</code></td>',
          ...
          // 검색 결과 카드
          '<tr>',
          '<td class="kms-ds-t-name">검색 결과 카드<br><small style="font-weight:300;letter-spacing:0">grid minmax(280px,1fr)</small></td>',
          '<td class="kms-ds-t-usage">전역 검색 결과 그리드 — 카테고리 태그 + 제목 + 요약 + 날짜. border:1px, padding:16px<br><code style="font-size:10px;font-family:monospace">.global-search-results-wrap .global-search-grid .global-search-item</code></td>',
          ...
          // 결과 없음
          '<tr>',
          '<td class="kms-ds-t-name">검색 결과 없음<br><small style="font-weight:300;letter-spacing:0">빈 상태</small></td>',
          '<td class="kms-ds-t-usage">검색어에 일치하는 결과가 없을 때 — 중앙 정렬 안내 텍스트<br><code style="font-size:10px;font-family:monospace">.global-search-empty</code></td>',
      ...
      // ────────────────────────────────────────────────────────
      {
        ...
        html: [
          ...
          // 기본 토스트
          '<tr>',
          '<td class="kms-ds-t-name">기본 토스트<br><small style="font-weight:300;letter-spacing:0">bg #1f1f1f · 흰 텍스트</small></td>',
          '<td class="kms-ds-t-usage">링크 복사, 일반 알림 — 하단 우측 fixed. .toast.show 시 translateY(0)로 나타남<br><code style="font-size:10px;font-family:monospace">.toast .toast.show</code></td>',
          ...
          // 성공 토스트
          '<tr>',
          '<td class="kms-ds-t-name">성공 토스트<br><small style="font-weight:300;letter-spacing:0">좌측 4px #248737</small></td>',
          '<td class="kms-ds-t-usage">저장 완료, 등록 성공 — 기본 토스트에 좌측 초록 border 추가<br><code style="font-size:10px;font-family:monospace">.toast.show.success</code></td>',
          ...
          // 오류 토스트
          '<tr>',
          '<td class="kms-ds-t-name">오류 토스트<br><small style="font-weight:300;letter-spacing:0">좌측 4px #ff5655</small></td>',
          '<td class="kms-ds-t-usage">저장 실패, 오류 발생 — 기본 토스트에 좌측 빨간 border 추가<br><code style="font-size:10px;font-family:monospace">.toast.show.error</code></td>',
          ...
          // 당겨서 새로고침
          '<tr>',
          '<td class="kms-ds-t-name">당겨서 새로고침<br><small style="font-weight:300;letter-spacing:0">모바일 상단 pull</small></td>',
          '<td class="kms-ds-t-usage">모바일에서 화면 아래로 당겨 새로고침 — 상단 중앙 고정 인디케이터<br><code style="font-size:10px;font-family:monospace">.pull-refresh-indicator.visible / .ready</code></td>',
      ...
      // ────────────────────────────────────────────────────────
      {
        ...
        html: [
          ...
          // 미니 리스트 아이템
          '<tr>',
          '<td class="kms-ds-t-name">미니 리스트 아이템<br><small style="font-weight:300;letter-spacing:0">.mini-item</small></td>',
          '<td class="kms-ds-t-usage">홈 사이드바·관련 게시글 목록 — 썸네일(우측) + 레이블 + 제목 + 날짜 + 공유<br><code style="font-size:10px;font-family:monospace">.mini-list .mini-item .mini-item-row .mini-thumb .mini-meta</code></td>',
          ...
          // 빈 상태
          '<tr>',
          '<td class="kms-ds-t-name">빈 상태 메시지<br><small style="font-weight:300;letter-spacing:0">.mini-empty / .list-empty</small></td>',
          '<td class="kms-ds-t-usage">게시글·일정이 없을 때 표시 — 중앙 정렬 안내 텍스트<br><code style="font-size:10px;font-family:monospace">.mini-empty .list-empty</code></td>',
          ...
          // 공유 버튼
          '<tr>',
          '<td class="kms-ds-t-name">공유 버튼<br><small style="font-weight:300;letter-spacing:0">.mini-share-link</small></td>',
          '<td class="kms-ds-t-usage">미니 리스트 아이템 하단 — 링크 클립보드 복사 후 토스트 알림 트리거<br><code style="font-size:10px;font-family:monospace">.mini-share-link</code></td>',
          '<td class="kms-ds-t-preview"><button class="mini-share-link" type="button">공유하기</button></td>',
          '</tr>',
          // 로딩 상태
          '<tr>',
          '<td class="kms-ds-t-name">로딩 상태<br><small style="font-weight:300;letter-spacing:0">.loading-state</small></td>',
          '<td class="kms-ds-t-usage">API 데이터 요청 중 표시 — 3점 애니메이션 (loading-dots · 3 × span)<br><code style="font-size:10px;font-family:monospace">.loading-state .loading-dots span</code></td>',
          '<td class="kms-ds-t-preview"><div class="loading-state"><div class="loading-dots"><span></span><span></span><span></span></div></div></td>',
          '</tr>',
          // skip-link
          '<tr>',
          '<td class="kms-ds-t-name">접근성 건너뛰기 링크<br><small style="font-weight:300;letter-spacing:0">.skip-link (포커스 시 노출)</small></td>',
          '<td class="kms-ds-t-usage">키보드 사용자 — Tab 첫 포커스 시 화면에 나타나 본문으로 바로 이동<br><code style="font-size:10px;font-family:monospace">.skip-link</code></td>',
