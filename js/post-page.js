  ...
  frames.forEach(function (frame) {
    ...
    GW.geocodeOsm(addr)
      .then(function (geo) {
        ...
        frame.innerHTML = '<iframe class="post-location-map" src="' + geo.embedSrc + '" title="' + GW.escapeHtml(title) + ' 지도" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>';
      })
      .catch(function () {
