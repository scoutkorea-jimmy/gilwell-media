...
(function () {
  ...
  window.showAdminTab = function (tab, skipGroupSync) {
    ...
    if (tab === 'marketing' && typeof window.loadMarketingPage === 'function') window.loadMarketingPage();
    if (tab === 'write') _maybeRestoreAdminDraft();
    if (tab === 'glossary' && window.loadGlossaryAdmin) window.loadGlossaryAdmin();
    if (tab === 'calendar' && typeof window.loadCalendarAdmin === 'function') window.loadCalendarAdmin();
  ...
  AdminShared.defaultCalendarCopy = defaultCalendarCopy;
  AdminShared.populateCalendarCopyEditor = populateCalendarCopyEditor;
  AdminShared.initPointerSortable = _initPointerSortable;
  AdminShared.buildPageNumberButtons = buildPageNumberButtons;
  AdminShared.renderAnalyticsList = renderAnalyticsList;
  AdminShared.setText = setText;
  AdminShared.setMetricText = setMetricText;
  AdminShared.formatMetricCompact = formatMetricCompact;
  AdminShared.formatMetricExact = formatMetricExact;
