...
> Dreampath 관련 **모든** AI 작업 규칙은 **[dreampath/DREAMPATH.md](../dreampath/DREAMPATH.md)** 에 있습니다.
> 케이스 스터디 / 버전 히스토리는 **[dreampath/DREAMPATH-HISTORY.md](../dreampath/DREAMPATH-HISTORY.md)** 에 있습니다.
...
| 경로 | 문서 원본 |
|---|---|
| `dreampath/**`, `functions/api/dreampath/**` | **[dreampath/DREAMPATH.md](../dreampath/DREAMPATH.md)** (Dev Rules) |
...
이때는 `dreampath/DREAMPATH.md` Section 10 ("CSP: `/dreampath` 레거시 경로") 와 Section 15.2
...
- 2026-04-24 CSP 회귀: `isLegacyInlinePath()` 에 `/dreampath` 누락 → 사이드바 전체 마비.
  상세: `dreampath/DREAMPATH-HISTORY.md` 2026-04-24 · A.
