...
2. Link to `DreamPath - Document Templates.html`. For tidy URLs you may rename it (e.g. `templates.html`).
...
- **Tweaks:** inside Dreampath PMO, the right-side editor panel controls importance, density, paper, page count, footer/star visibility, and document-number regeneration.
